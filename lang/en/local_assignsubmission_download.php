...
$string['nofeedback'] = 'No feedback files available';
$string['nofeedbackneweras'] = 'No feedback was given after {$a}';
...
$string['onegroupsubmission'] = 'Include only one submission per group';
$string['onegroupsubmission_help'] = 'If enabled, only one submission per group is included in the download when group submissions are enabled for the assignment. This is useful to avoid duplicate files.';
...
$string['privacy:metadata:local_assignsubm_download:splitgroupsintofolders'] = 'Whether downloaded files are split into folders per group.';
...
$string['privacy:metadata:local_assignsubm_feedback:splitgroupsintofolders'] = 'Whether downloaded files are split into folders per group.';
...
$string['privacy:metadata:preference:splitgroupsintofolders'] = 'Preference on whether to split downloaded files into folders per group.';
...
$string['splitgroupsintofolders'] = 'Split files from groups into folders';
$string['splitgroupsintofolders_help'] = 'Split files from groups into folders';
